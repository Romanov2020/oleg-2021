        ...
        if(isset($_POST["captcha"]) && !empty($captcha)){
            ...
            if(isset($_POST["email"])){
                ...
                if(!empty($email)){
                    ...
                    $result_query = $mysqli->query("SELECT `email` FROM `usemap` WHERE `email`='".$email."'");
            ...
            $result_query_insert = $mysqli->query("INSERT INTO `usemap` (first_name, last_name, email, password) VALUES ('".$first_name."', '".$last_name."', '".$email."', '".$password."')");
